        ...
        <div className={styles.termsbody}>
          ...
          <div className={styles.paragraphdiv}>
            ...
            <div className={styles.text}>
              This website is operated by Cruffin Premium (A Brand Name of
              Freshverse Foods Pvt. Ltd.). Throughout the site, the terms “we”,
              “us” and “our” refer to Cruffin Premium. Cruffin Premium offers
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 1 - ONLINE STORE TERMS</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 2 - GENERAL CONDITIONS</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            ...
            <div className={styles.text}>
              ...
              our Cancellations & Refund Policy.
            </div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            ...
            <div className={styles.text}>
              For more details, please review our Cancellations & Refund Policy.
            </div>
          </div>

          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 7 - OPTIONAL TOOLS</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 8 - THIRD-PARTY LINKS</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 12 - PROHIBITED USES</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            ...
            <div className={styles.text}>
              In no case shall Cruffin Premium, Freshverse, our directors,
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 14 - INDEMNIFICATION</div>
            <div className={styles.text}>
              You agree to indemnify, defend and hold harmless Cruffin Premium
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 15 - SEVERABILITY</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 16 - TERMINATION</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 17 - ENTIRE AGREEMENT</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 18 - GOVERNING LAW</div>
            <div className={styles.text}>
          ...
          <div className={styles.paragraphdiv}>
            <div className={styles.title}>SECTION 20 - CONTACT INFORMATION</div>
            <div className={styles.text}>
              Questions about the Terms of Service should be sent to us at
              cruffin.premium@gmail.com.
            </div>
            <div className={styles.text}>
            ...
            <ul className={styles.uldiv}>
              <li className={styles.lidiv}>
                Cruffin Premium Cakes & Desserts (A brand name of Freshverse
                Foods Pvt. Ltd.)
              </li>
              <li className={styles.lidiv}>
                mohit@freshverse.in & social@cruff.in
              </li>
              <li className={styles.lidiv}>
                Sector 37, Block B, 122001 Gurugram HR, India.
              </li>
              <li className={styles.lidiv}>+91 98584 89828</li>
              <li className={styles.lidiv}>Registration No. 06AAFCF3785K1Z9</li>
            </ul>
          </div>
        </div>
      </div>
